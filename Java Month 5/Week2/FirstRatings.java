...
public class FirstRatings {
    ...
    public ArrayList<Movie> loadMovies(String fileString){
    ...
    public ArrayList<Rater> loadRaters(String fileString){
        FileResource fr = new FileResource(fileString);
        int recordCount = 0;
        for(CSVRecord rec : fr.getCSVParser()){
            recordCount++;      
            //Rater cRater = new PlainRater(rec.get("rater_id"));
            Rater cRater = new EfficientRater(rec.get("rater_id"));
